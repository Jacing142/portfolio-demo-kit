...
The plan is written by the agent (see .claude/skills/portfolio-demo/SKILL.md):
...
comes from the API response, never from the agent. Results are cached by request, so
