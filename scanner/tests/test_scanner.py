"""Scanner tests. Run from the repo root: python3 -m unittest discover -s scanner/tests -t ."""
...
from scanner import canaries, checks, scan
from scanner.__main__ import main
from scanner.config import load
from scanner.extract import output_texts, source_candidates
